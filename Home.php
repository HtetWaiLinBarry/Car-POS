...
<head>
    ...
    <title>Tharaphu Soe Myint</title>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <div class="menu">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="VehicleRegister.php">Vehicles</a></li>
                                <li><a href="#">Team</a></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="header-text">
                            <h1>Tharaphu Soe Myint</h1>
                            <p>Welcome To Tharaphu Soe Myint Car Sales!<br> Here, you can search for your desired vehicles and<br> trade in!</p>
                            <button>Learn More</button>
                            <button><a href="StaffEntry.php">Get Started!</a></button>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="another-text">
                            ...
                            <p>Only three steps required to get your own car!<br> Here they are!</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row ">
                    <div class="col-md-4 col-sm-4">
                        <div class="design-development one">
                            ...
                            <h2>Register!</h2>
                            <p>To be able to fully use our website, you must first be registered!</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <div class="design-development two">
                            ...
                            <h2>Browse!</h2>
                            <p>Browse what kind of vehicle you want!</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <div class="design-development three">
                            ...
                            <h2>Appointments!</h2>
                            <p>Make your appointments and come to our showroom to buy and receive the car that you want!</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="work-images">
                            <iframe width="100%" height="100%" src="https://www.youtube.com/watch?v=rXiTa2d5b1E" frameborder="0" allowfullscreen></iframe>
                    ...
                    <div class="col-md-5">
                        <div class="work-text-full">
                            <div class="work-text">
                                <h2>Multiple Kinds of Vehicles</h2>
                                <p>Ranging from sports cars to agricultural uses!</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="portfolia">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="port-text">
                            <h2>Our Recent Imports!</h2>
                            <p>You can check out our recent import cars!<br>  You're gonna love them!</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <div class="portfolio-part">
                            <img src="img/toyotarv4.jpg" alt="">
                            <div class="overlay-slide">
                                <h2>Toyota RAV4</h2>
                                <p>The Toyota RAV4 now makes it way to Myanmar!</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="portfolio-part">
                            <img src="img/hondacrv.jpg" alt="">
                            <div class="overlay-slide">
                                <h2>Honda CR V 2019</h2>
                                <p>Seek out the road less traveled in the 2019 Honda CR-V!</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="team-text">
                            ...
                            <p>Meet Our Awesome Team. Check out our awesome staffs here!</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="my-claint owl-carousel owl-theme">
                            <div class="item">
                                <img src="img/tinzar.jpg" alt="">
                                <div class="item-overlay"></div>
                                <div class="item-text">
                                    <h3>Ma Tin Zar Htun</h3>
                                    <h4>Assistant Chief Accountant</h4>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-12">
                        <div class="contact-text">
                            <h2>Contact US!</h2>
                            <p>Please contact us if there's something you want to tell us!</p>
                        </div>
                    </div>
