...
<head>
    ...
    <title>TSM Customer Dashboard</title>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="logo">
                            <h2><a href="CustomerDashboard.php">TSM</a></h2>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="header-text">
                            ...
                            <p>Welcome To Tharaphu Soe Myint Car Sales!<br> You can browse all the vehicles and cars you want!<br> Have Fun!</p>
                            <button><a href="CustomerTools.php">START</a></button>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="another-text">
                            ...
                            <p>Different types of vehicles<br> with warranty at our measure.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row ">
                    <div class="col-md-4 col-sm-4">
                        <div class="design-development one">
                            <i class="material-icons">RE</i>
                            <h2>Register!</h2>
                            <p>As our customer, you need to first be registered!</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <div class="design-development two">
                            ...
                            <h2>Browse!</h2>
                            <p>You can choose any vehicle or vehicles you like from our list!</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <div class="design-development three">
                            <i class="material-icons">PR</i>
                            <h2>Purchase!</h2>
                            <p>You will be able to purchase a vehicle fast and cheap!</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-md-3 col-sm-6 col-xs-6">
                                    <div class="footer-text-single">
                                        <h3>Tools</h3>
                                        <p><a href="CustomerRegister.php">Create Account</a></p>
                                        <p><a href="#">Log In</a></p>
