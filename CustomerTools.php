...
<head>
    ...
    <title>TSM Tools Dashboard</title>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <div class="menu">
                            <ul class="nav navbar-nav">
                                <li class="active"><a href="#">Customer Tools Dashboard</a></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="header-text">
                            <h1>TSM Tools Dashboard</h1>
                            <p>Welcome To Tharaphu Soe Myint Car Sales!<br> You can browse all the tools available here!<br> Have Fun!</p>
                            <button><a href="VehicleDash.php">Display Form</a></button>
                            <button><a href="BrandDash.php">Register Form</a></button>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="another-text">
                            <h3>RULES</h3>
                            <p>Please Follow Our Rules!<br> Here they are!</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row ">
                    <div class="col-md-4 col-sm-4">
                        <div class="design-development one">
                            ...
                            <h2>Authorization!</h2>
                            <p>Please be authorized to our page!</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <div class="design-development two">
                            <i class="material-icons">color_lens</i>
                            <h2>Do not exploit!</h2>
                            <p>There will be many fatal outcomes if you exploit the server!</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <div class="design-development three">
                            ...
                            <h2>Be Nice!</h2>
                            <p>Be Nice to the Staff members!</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="our-team">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="team-text">
                            <h2>Top Customer Of The Month!</h2>
                            <p>Meet Our Awesome Customers!</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="footer-text">
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-6">
                                    <div class="footer-text-single">
                                        <h3>Tools</h3>
                                        <p><a href="StaffEntryDash.php">Create Account</a></p>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 col-xs-6">
                                    <div class="footer-text-single">
